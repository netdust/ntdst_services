...
class Vite {
    ...
    public array $jsDeps = [];
    public function __construct($isChild, $env) {
        ...
        $this->distUri = $dirUri . '/' . $env['output_dir'];
        $this->distPath = $dir . '/' . $env['output_dir'];
        $this->wpEnqueueId = $env['wp_enqueue_id'];
        $this->server = $env['protocol'] . '://' . $env['host'] . ':' . $env['port'];
        $this->entryPoint = $env['entry_point'];
